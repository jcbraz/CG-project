...
void getBezierPoint(float u, float v, float* px, float* py, float* pz, float* normalV) {
	...
	float UMP[3][4];
	mult1dMatrixVector(UM, (float*)Px, UMP[0]);
	mult1dMatrixVector(UM, (float*)Py, UMP[1]);
	mult1dMatrixVector(UM, (float*)Pz, UMP[2]);

	float UMPd[3][4];
	mult1dMatrixVector(UMd, (float*)Px, UMPd[0]);
	mult1dMatrixVector(UMd, (float*)Py, UMPd[1]);
	mult1dMatrixVector(UMd, (float*)Pz, UMPd[2]);
